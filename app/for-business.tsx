...
export default function ForBusinessScreen() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background, paddingTop: insets.top }]}>
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        ...
        <Text style={[fontVariants.h4, { color: colors.foreground }]}>For Business</Text>
        <View style={{ width: 38 }} />
      </View>
      <View style={styles.center}>
        <Icon name="briefcase" size={56} color={colors.mutedForeground} />
        ...
        <Text style={[fontVariants.caption, { color: colors.mutedForeground, textAlign: 'center' }]}>
          Enterprise celebrity booking solutions coming soon
        </Text>
      </View>
    </View>
  );
