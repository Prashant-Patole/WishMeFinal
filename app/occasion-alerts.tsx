  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background, paddingTop: insets.top }]}>
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        ...
        <Text style={[fontVariants.h4, { color: colors.foreground }]}>Occasion Alerts</Text>
        <View style={{ width: 38 }} />
      </View>
      <View style={styles.center}>
        <Icon name="bell" size={56} color={colors.mutedForeground} />
        ...
        <Text style={[fontVariants.caption, { color: colors.mutedForeground, textAlign: 'center' }]}>
          Never miss an important occasion — alerts and reminders coming soon
        </Text>
      </View>
    </View>
  );
