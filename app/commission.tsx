  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background, paddingTop: insets.top }]}>
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        ...
        <Text style={[fontVariants.h4, { color: colors.foreground }]}>Commission</Text>
        <View style={{ width: 38 }} />
      </View>
      <View style={styles.center}>
        <Icon name="trending-up" size={56} color={colors.mutedForeground} />
        ...
        <Text style={[fontVariants.caption, { color: colors.mutedForeground, textAlign: 'center' }]}>
          Track your earnings and commission history here
        </Text>
      </View>
    </View>
  );
