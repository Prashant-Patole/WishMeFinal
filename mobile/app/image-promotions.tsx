...
export default function ImagePromotionsScreen() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background, paddingTop: insets.top }]}>
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        ...
        <Text style={[fontVariants.h4, { color: colors.foreground }]}>Image Promotions</Text>
        <View style={{ width: 38 }} />
      </View>
      <View style={styles.center}>
        <Icon name="zap" size={56} color={colors.mutedForeground} />
        ...
        <Text style={[fontVariants.caption, { color: colors.mutedForeground, textAlign: 'center' }]}>
          Celebrity-powered image promotion campaigns coming soon
        </Text>
      </View>
    </View>
  );
