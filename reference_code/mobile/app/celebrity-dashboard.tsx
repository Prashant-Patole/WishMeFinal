...
export default function CelebrityDashboardScreen() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background, paddingTop: insets.top }]}>
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        ...
        <Text style={[fontVariants.h4, { color: colors.foreground }]}>Celebrity Dashboard</Text>
        <View style={{ width: 38 }} />
      </View>
      <View style={styles.center}>
        <Icon name="sparkles" size={56} color={colors.primary} />
        ...
        <Text style={[fontVariants.caption, { color: colors.mutedForeground, textAlign: 'center' }]}>
          Manage your bookings, earnings, and fan interactions from your dashboard
        </Text>
      </View>
    </View>
  );
